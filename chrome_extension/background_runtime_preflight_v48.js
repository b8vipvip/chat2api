(() => {
  ...
  // Worker bundle 0.8.36 keeps the v71 request/response epoch while requiring
  ...
  // ownership is independently enforced by background entry v0.8.36.
  const REQUIRED_BUNDLE = "0.8.36";
