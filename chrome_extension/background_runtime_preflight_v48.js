(() => {
  ...
  // Worker bundle 0.8.31 keeps the v71 request/response epoch while requiring
  ...
  // ownership is independently enforced by background entry v0.8.31.
  const REQUIRED_BUNDLE = "0.8.31";
