...
RUN chmod 755 /app/scripts/bootstrap_linux_worker.sh /app/worker_payload/scripts/linux_worker_generation_probe.sh /app/worker_payload/scripts/linux_worker_slot_chrome_launcher.sh /app/worker_payload/scripts/linux_worker_slot_install.sh \
