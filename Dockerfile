...
COPY scripts/linux_worker_agent.py scripts/linux_worker_agent_v43.py scripts/linux_worker_agent_v44.py scripts/linux_worker_proxy.py scripts/linux_worker_remote_login.py scripts/linux_worker_remote_clipboard_v45.py scripts/linux_worker_tab_init.py scripts/linux_worker_slot_agent.py ./worker_payload/scripts/
