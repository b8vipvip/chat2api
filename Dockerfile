...
COPY scripts/linux_worker_agent.py scripts/linux_worker_proxy.py scripts/linux_worker_remote_login.py ./worker_payload/scripts/
COPY scripts/linux_worker_watchdog.sh scripts/linux_extension_autoreload.sh scripts/linux_worker_proxy_apply.sh scripts/linux_worker_chrome_launcher.sh ./worker_payload/scripts/
