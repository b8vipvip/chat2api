...
def test_runtime_versions_and_features() -> None:
    ...
    assert 'CHROME_BRIDGE_BUNDLE_VERSION = "0.8.42"' in source
...
def test_runtime_preflight_requires_request_v6_and_evidence_overlays() -> None:
    ...
    assert 'const REQUIRED_BUNDLE = "0.8.42"' in source
    ...
    assert 'const REQUIRED_BUNDLE = "0.8.42"' in contract
    ...
    assert 'bundle: "0.8.42"' in marker
