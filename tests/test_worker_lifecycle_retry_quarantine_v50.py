...
def test_runtime_versions_and_features() -> None:
    ...
    assert 'SERVER_RUNTIME_VERSION = "0.22.41"' in source
    assert 'CHROME_BRIDGE_BUNDLE_VERSION = "0.8.14"' in source
    for marker in (
...
def test_runtime_preflight_requires_v50_v51_and_v55_overlays() -> None:
    ...
    assert 'const REQUIRED_BUNDLE = "0.8.14"' in source
