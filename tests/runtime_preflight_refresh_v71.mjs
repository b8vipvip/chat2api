...
function currentContract() {
  return {
    ...
    marker: { bundle: "0.8.16", revision: 71 },
    modules: {
      request_v6: true,
...
async function runScenario({ hotHealWorks }) {
  ...
  return { injected, reloads, baseEnsures, saved, state: context.__CHAT2API_BACKGROUND_RUNTIME_PREFLIGHT_V71__ };
}
...
assert.equal(loading.state.last?.marker?.bundle, "0.8.16");
