...
function currentContract() {
  return {
    ...
    marker: { bundle: "0.8.40", revision: 71 },
    modules: {
      request_v6: true,
      ...
      terminal_integrity_v89: true,
      conversation_quota_failover_v95: true,
      ui_hygiene_v101: true,
    },
  };
}
...
assert.equal(hot.state.last?.terminal_integrity_revision, 89);
...
assert.equal(loading.state.last?.terminal_integrity_revision, 89);
