...
def test_runtime_contract_separates_protocol_from_new_bundle_build():
    ...
    assert 'model-capability-routing-v2' in runtime
    ...
    assert 'multimodal-upload-v68-api-key-console-v68-rich-response-v69-content-runtime-v71-multimodal-main-world-v78' in runtime
