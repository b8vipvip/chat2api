...
def test_runtime_contract_requires_worker_0825_single_owner_plus_network_recovery():
    ...
    assert 'const REQUIRED_BUNDLE = "0.8.26"' in preflight
    assert '"content_network_stream_recovery_v55.js"' in preflight
    assert 'const REQUIRED_BUNDLE = "0.8.26"' in contract
    ...
    assert 'bundle: "0.8.26"' in marker
