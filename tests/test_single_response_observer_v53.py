...
def test_runtime_contract_requires_worker_0831_single_owner_plus_network_recovery():
    ...
    assert 'CHROME_BRIDGE_BUNDLE_VERSION = "0.8.39"' in runtime
    ...
    assert 'const REQUIRED_BUNDLE = "0.8.39"' in preflight
    assert '"content_network_stream_recovery_v55.js"' in preflight
    assert 'const REQUIRED_BUNDLE = "0.8.39"' in contract
