...
def test_manifest_loads_response_capture_v41_before_canonical_terminal_path() -> None:
    ...
    assert scripts.index("content_response_capture_v41.js") < scripts.index("content_network_stream_recovery_v55.js") < scripts.index("content_completion_v6.js")
    ...
    assert bootstrap.index('"content_response_capture_v41.js"') < bootstrap.index('"content_network_stream_recovery_v55.js"') < bootstrap.index('"content_completion_v6.js"')
