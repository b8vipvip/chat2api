...
def test_manifest_loads_response_capture_v41_after_request_v5() -> None:
    ...
    assert scripts.index("content_response_capture_v41.js") < scripts.index("content_response_stream_recovery_v49.js") < scripts.index("content_completion_v6.js")
    ...
    assert bootstrap.index('"content_response_capture_v41.js"') < bootstrap.index('"content_response_stream_recovery_v49.js"') < bootstrap.index('"content_completion_v6.js"')
