...
RUNTIME_FEATURE_REVISION = "capacity-native-v37-bundle-084-runtime-logs-v1-playground-lifecycle-v1-spare-freshness-v39-request-recovery-v40"
...
def version_contract_payload(app: FastAPI) -> dict[str, Any]:
    ...
    return {
        ...
        "chrome_bridge": {
            ...
            "build_revision": "capacity-native-v37-r3-spare-freshness-v39-request-recovery-v40",
