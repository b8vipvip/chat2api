...
SERVER_RUNTIME_VERSION = "0.22.91"
PREVIOUS_SERVER_RUNTIME_VERSION = "0.22.90"
PREVIOUS_PREVIOUS_SERVER_RUNTIME_VERSION = "0.22.89"
PREVIOUS_PREVIOUS_PREVIOUS_SERVER_RUNTIME_VERSION = "0.22.88"
PREVIOUS_PREVIOUS_PREVIOUS_PREVIOUS_SERVER_RUNTIME_VERSION = "0.22.87"
...
def version_contract_payload(app: FastAPI) -> dict[str, Any]:
    ...
    return {
        ...
        "features": {
            ...
            "responses_terminal_integrity_v110": True,
            "worker_terminal_integrity_v89": True,
