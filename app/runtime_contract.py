...
# v0.22.95+: one release version is the single source of truth for the
...
# numbers.
RELEASE_VERSION = "0.22.95"
SERVER_RUNTIME_VERSION = "0.22.95"
...
CHROME_BRIDGE_VERSION = "0.22.95"
CHROME_BRIDGE_BUNDLE_VERSION = "0.22.95"
