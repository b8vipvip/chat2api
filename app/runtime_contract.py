...
SERVER_RUNTIME_VERSION = "0.22.78"
...
CHROME_BRIDGE_BUNDLE_VERSION = "0.8.33"
...
def version_contract_payload(app: FastAPI) -> dict[str, Any]:
    ...
    return {
        ...
        "features": {
            ...
            "linux_worker_device_console_v122": True,
            "linux_worker_console_v123": True,
