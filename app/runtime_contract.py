...
def version_contract_payload(app: FastAPI) -> dict[str, Any]:
    ...
    return {
        ...
        "chrome_bridge": {
            ...
            "build_revision": "capacity-native-v37-response-capture-v41-request-hygiene-v42-generation-liveness-v49-network-response-v55-parser-v62-tool-isolation-v48-runtime-preflight-v71-native-tool-stream-v63-multimodal-main-world-v78-multimodal-safe-submit-v85-worker-disabled-window-guard-v86-ui-hygiene-v101-responses-tool-stream-v118-capacity-scheduler-v58-single-route-window-authority-v30-window-observer-v90-route-close-terminal-v91-routed-window-limit-v121-release-v0832-physical-startup-window-observer-v90-release-v0833-linux-device-authority-v124-extension-autopair-v1-release-v0834-worker-isolated-ops-v126-release-v0835-persistent-prewarmed-window-pool-v132-canonical-v135-release-v0836-qnbot-route-recovery-v136-request-id-namespace-v136-release-v0837-network-response-parser-v63-citation-regression-guard-v139-release-v0838-qnbot-orphan-owner-recovery-v140-release-v0839-chatgpt-choice-policy-v143-release-v0841-single-window-lifecycle-authority-v137-release-v0842",
            ...
            "network_response_parser_revision": 63,
        ...
        "features": {
            ...
            "admin_worker_manager_layout_v138": True,
            ...
            "qnbot_orphan_owner_recovery_v140": True,
            ...
            "window_observer_terminal_clear_v90": True,
            "running_request_history": True,
            "playground_cancellation": True,
            "generation_activity_watchdog": True,
            "fresh_spare_rotation": False,
            "terminal_request_recovery": False,
            "failed_route_recycle": False,
            "failed_route_quarantine": False,
            ...
            "network_response_parser_v63": True,
            "native_tool_stream_v63": True,
            "responses_api_v108": True,
            "responses_native_web_search_v108": True,
            "responses_emulated_tools_v109": True,
            "responses_function_call_output_v109": True,
            "responses_owner_isolation_v109": True,
            ...
            "responses_tool_stream_v118": True,
            "responses_tool_continuation_v141": True,
            ...
            "worker_ui_hygiene_health_modal_v101": True,
            ...
            "linux_worker_same_host_slots_v1": False,
            "linux_worker_remote_unicode_clipboard_v121": True,
            "linux_worker_device_console_v122": False,
            "linux_worker_console_v123": False,
            "linux_worker_device_authority_v124": True,
            "linux_worker_extension_autopair_v124": True,
            "linux_worker_public_https_origin_v125": True,
            "linux_worker_isolated_management_v126": False,
            "linux_worker_slot_isolated_ops_v126": False,
            "linux_worker_device_controller_agent_v127": True,
            "linux_worker_shared_device_pairing_v127": True,
            "linux_worker_shared_device_proxy_v127": True,
            "request_device_identity_sibling_v142": True,
            "linux_worker_profile_only_isolation_v127": True,
            "linux_worker_device_controller_provision_rw_v128": True,
            ...
            "worker_physical_window_live_truth_v89": False,
            ...
            "file_upload_quota_terminal_recycle_v96": False,
            "managed_window_open_stagger_v85": True,
            "reserve_spare_target_semantics_v85": False,
            ...
            "successful_terminal_monotonic_v88": False,
            "long_prompt_fast_insert_v88": True,
            "admin_window_manager_v88": True,
            "admin_navigation_freeze_v89": True,
            "admin_navigation_bounded_v90": True,
            "admin_request_stability_v92": True,
            "admin_request_single_owner_v94": True,
            "request_history_conversation_viewer_v97": True,
            "admin_window_live_truth_v89": False,
            ...
            "server_update_direct_start_v97": True,
            "user_console_v104": True,
            "user_account_api_key_isolation_v104": True,
            "user_pricing_billing_v104": True,
            "user_payment_zpay_v104": True,
            "user_payment_channels_v106": True,
            "user_payment_paypal_v106": True,
            "user_payment_usdt_trc20_v106": True,
            "user_payment_settlement_safety_v107": True,
        },
        "protocols": {"realtime_voice": LIVE_PROTOCOL_VERSION},
    }
...
def _admin_version_script() -> str:
  ...
  const observeVersionNode = node => {{
    ...
    new MutationObserver(() => patchVersion()).observe(node, {{ childList: true, characterData: true, subtree: true }});
  }}
...
def install_runtime_contract(app: FastAPI) -> FastAPI:
    ...
    async def admin_runtime_version_js() -> Response:
        return Response(_admin_version_script(), media_type="application/javascript", headers={"Cache-Control": "no-store, no-cache, must-revalidate"})
    ...
    async def runtime_contract_response(request: Request, call_next):
        ...
        if path in {"/admin", "/developers"} and "text/html" in content_type:
            ...
            if path == "/admin":
                for asset in (ADMIN_LINUX_WORKERS_ASSET, ADMIN_LINUX_PROXY_CATALOG_ASSET, ADMIN_EXTENSION_COLUMNS_ASSET):
