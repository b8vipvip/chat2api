(() => {
  ...
  // v144 deliberately does not mutate the canonical Worker list. Worker list
  // structure and presentation belong to admin_extension_columns.js and its
  // bounded presentation stage. This module owns identity decoration only for
  // the window manager and Linux Worker manager.
  const state = { version: 144, observer: null };
  ...
  function start() {
    ...
    document.documentElement.dataset.chat2apiWorkerIdentityRevision = "144";
  }
